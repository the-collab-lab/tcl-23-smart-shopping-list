...
export default function List({ token }) {
  ...
  return (
    <>
      ...
      <div
        class="bg-teal border-t-4 rounded-b text-midnight-green border-caribbean-green px-4 py-3 shadow-md w-full"
        role="alert"
      >
        <div class="flex">
          <div class="py-1 text-caribbean-green">
            <svg
          ...
          <div class="flex items-center justify-around w-full">
            <p class="font-bold">Here's your token</p>
